...
```
### Warnings
All of these functions throw errors for non logical type input and for inputs not equal in length. This package is compeletly safe to use as it passed the TRAVIS CL test & RStudio test. The package is under the CC0 license which means anybody can use it for free. If you have any issue contact the maintainer : brendamoralescalzada@hotmail.com
Github repo : https://github.com/Bemoc/farsdata . 
